 ...
 */
export const getAvailabilityScoreColor = (score: number): string => {
...
/**
 * Get color for availability (alias for compatibility)
 */
export const getAvailabilityColor = getAvailabilityStatusColor;
