...
async function testProgressMonitoringDirect() {
  try {
    console.log('🔍 Testing Progress Monitoring System Directly...\n');
    ...
    // Use a specific plan ID from the database
    const planId = '68cd29c5d58ad966ab2ca486'; // Latest plan
