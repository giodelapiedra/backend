...
-- This is the missing piece that handles clinician status updates
...
BEGIN
    ...
    -- Automatically set return_to_work = true in incidents table
...
-- CRITICAL MISSING TRIGGER: Update incident return_to_work status when case status changes
-- This is the trigger that was missing from your original setup!
...
-- Update existing incidents based on their related case status
